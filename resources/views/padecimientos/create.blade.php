        ...
        <div class="card-body px-md-5 pb-5 pt-3">
            <form action="{{ route('padecimientos.store') }}" method="POST">
                ...
                <div class="mt-5 d-flex align-items-center">
                    <button type="submit" class="btn btn-info px-4 shadow-sm" style="transform: none;"><i class="bx bx-save me-2"></i>Guardar Padecimiento</button>
                    <a href="{{ route('padecimientos.index') }}" class="btn btn-danger ms-3"><i class="bx bx-x me-1"></i>Cancelar</a>
                </div>
            </form>
        </div>
    </div>
